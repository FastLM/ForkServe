...
Decoding acceleration then stops winner generation only when the last non-empty line is a finished answer (\texttt{\#\#\#\#} or a closed \texttt{\textbackslash boxed}), and keeps committed decode ahead of speculative prefill in a two-class scheduler.
...
Setting N repeats the same four-system forest on six models ($n{=}40$): GSM8K peak KV is $0.72$--$0.75\times$ APC on every family, and Game24 is $0.57$--$0.62\times$.
A last-line answer stop on DeepSeek-R1, Llama-3-8B, and Mistral-7B ($n{=}32$, $\mathrm{tp}{=}2$) keeps GSM8K peak at $0.73\times$ APC.
ForkServe+ scores $18/32$ (APC $16/32$) on DeepSeek-R1 and $22/32$ (APC $23/32$) on Llama-3-8B, and drops to $6/32$ (APC $11/32$) on Mistral-7B.
A $k$ sweep on the same three models ($n{=}16$) leaves the spine flat while APC grows: the ratio moves from $0.89$--$0.90$ at $k{=}2$ to $0.53$--$0.55$ at $k{=}8$.
On MATH-500 ($n{=}200$, $D{=}2048$) DeepSeek-R1 peak is $0.75\times$ APC and Qwen3-4B peak is $0.79\times$.
ForkServe+ keeps that peak and brings MATH-500 fan-out to the APC level ($1553$ vs.\ $1604$\,ms on DeepSeek-R1, $1223$ vs.\ $1178$\,ms on Qwen3-4B).
\end{abstract}
...
O. Branching and batch width & $2$ & $0,1$ & $16$; batches of $4$ or $1{\times}16$ & GSM8K $k\in\{2,4,8\}$, depth $2$ \\
P. Contest forest, $D{=}2048$ & $2$ & $2,3$ & $200$ / $73$; batches of $8$ & MATH-500, AIME (R1-8B, Qwen3-4B) \\
\bottomrule
\end{tabular}
...
FS+ $D^{+}$ & $7206$ & $11704$ & $11162$ & $5262$ & $9660$ & --- \\
...
FS+ e2e (s) & $12.56$ & $8.63$ & $36.10$ & $11.07$ & $18.10$ & --- \\
\bottomrule
\end{tabular}%
}
...
ForkServe+ stop is safe on Llama-3-8B and cuts tokens on Qwen without always matching accuracy.}
\end{table}
...
Right: ForkServe tracks APC accuracy; ForkServe+ matches on Llama-3-8B and drops on Qwen3-4B / Mistral / Qwen3-14B.}
\end{figure}
...
\subsection{Last-line answer stop}

The follow-up stops committed decode only when the last non-empty line is a finished answer (\texttt{\#\#\#\#} with a number, or a closed \texttt{\textbackslash boxed}).
An earlier \texttt{\#\#\#\#} is treated as an intermediate step, and a bare \texttt{</think>} is not a stop.
Same weights, $\mathrm{tp}{=}2$, two A100-SXM4 40GB, $n{=}32$.
APC and ForkServe do not use the stop list; ForkServe+ does.
Peak is the maximum over chunks.
GSM8K uses $D{=}512$; Game24 uses $D{=}256$.
...
\toprule
 & & \multicolumn{3}{c}{DeepSeek-R1-8B} & \multicolumn{3}{c}{Llama-3-8B} & \multicolumn{3}{c}{Mistral-7B} \\
\cmidrule(lr){3-5}\cmidrule(lr){6-8}\cmidrule(lr){9-11}
 & & APC & FS & FS+ & APC & FS & FS+ & APC & FS & FS+ \\
\midrule
GSM8K & peak & $1493$ & $1093$ & $1093$ & $1485$ & $1085$ & $1085$ & $1521$ & $1121$ & $1121$ \\
 & accuracy & $0.500$ & $0.562$ & $0.562$ & $0.719$ & $0.750$ & $0.688$ & $0.344$ & $0.344$ & $0.188$ \\
 & correct & $16/32$ & $18/32$ & $18/32$ & $23/32$ & $24/32$ & $22/32$ & $11/32$ & $11/32$ & $6/32$ \\
 & decode tokens & $16384$ & $13887$ & $12693$ & $16384$ & $4711$ & $5101$ & $16384$ & $6999$ & $6723$ \\
 & e2e (s) & $17.64$ & $17.66$ & $17.61$ & $12.87$ & $10.13$ & $12.98$ & $11.27$ & $13.88$ & $13.46$ \\
Game24 & peak & $1064$ & $616$ & $616$ & $1224$ & $736$ & $736$ & $1296$ & $728$ & $728$ \\
 & success & $1/32$ & $0/32$ & $1/32$ & $0/32$ & $0/32$ & $0/32$ & $0/32$ & $0/32$ & $0/32$ \\
 & e2e (s) & $9.00$ & $8.91$ & $8.82$ & $0.50$ & $0.43$ & $0.32$ & $8.57$ & $8.55$ & $8.36$ \\
\bottomrule
\end{tabular}%
}
\caption{Last-line answer stop, $n{=}32$, $\mathrm{tp}{=}2$.
GSM8K peak is $1093/1493{=}0.73$, $1085/1485{=}0.73$, and $1121/1521{=}0.74$ of APC.
ForkServe+ decode tokens are $0.77\times$, $0.31\times$, and $0.41\times$ APC.
DeepSeek-R1 ForkServe+ scores $18/32$, above APC.
Llama-3-8B stays within one problem of APC; Mistral-7B loses five problems.
Game24 peaks are $0.58\times$, $0.60\times$, and $0.56\times$ APC.
Success stays at most $1/32$ because $D{=}256$ does not finish an equation.
Llama-3-8B Game24 emits $32$ decode tokens on every system (immediate EOS).}
\end{table}
...
\section{Branching, ablations, and long traces}
\label{sec:sens}

Setting O holds the model, the $16$ GSM8K items, $D{=}512$, and $\mathrm{tp}{=}2$, and changes only the tree.
Setting P is the same ToT recipe on MATH-500 and AIME with $D{=}2048$.
Both settings are complete for the models reported below.
Qwen3-8B contest traces are still running and are omitted.
...
\toprule
 & & \multicolumn{4}{c}{Llama-3-8B} & \multicolumn{4}{c}{Mistral-7B} \\
\cmidrule(lr){3-6}\cmidrule(lr){7-10}
 & & APC & FS & FS+ & FS/APC & APC & FS & FS+ & FS/APC \\
\midrule
$k{=}2$ & peak & $610$ & $550$ & $550$ & $0.90$ & $629$ & $569$ & $569$ & $0.90$ \\
 & accuracy & $12/16$ & $10/16$ & $11/16$ & & $4/16$ & $4/16$ & $5/16$ & \\
 & fan-out (ms) & $129$ & $181$ & $174$ & & $133$ & $190$ & $177$ & \\
$k{=}4$ & peak & $750$ & $550$ & $550$ & $0.73$ & $769$ & $569$ & $569$ & $0.74$ \\
 & accuracy & $10/16$ & $9/16$ & $9/16$ & & $5/16$ & $5/16$ & $5/16$ & \\
 & fan-out (ms) & $155$ & $238$ & $176$ & & $169$ & $247$ & $175$ & \\
$k{=}8$ & peak & $998$ & $550$ & $550$ & $0.55$ & $1033$ & $569$ & $569$ & $0.55$ \\
 & accuracy & $10/16$ & $11/16$ & $10/16$ & & $6/16$ & $4/16$ & $4/16$ & \\
 & fan-out (ms) & $224$ & $307$ & $179$ & & $258$ & $349$ & $191$ & \\
depth $2$ & peak & $814$ & $614$ & $614$ & $0.75$ & $841$ & $641$ & $641$ & $0.76$ \\
 & accuracy & $8/16$ & $8/16$ & $8/16$ & & $6/16$ & $6/16$ & $6/16$ & \\
\bottomrule
\end{tabular}%
}
\caption{Setting O, GSM8K $n{=}16$, $\mathrm{tp}{=}2$, $D{=}512$.
The spine peak is independent of $k$; APC peak grows with the hashed union.
DeepSeek-R1 at the same $n$ is $561/629{=}0.89$ at $k{=}2$, $561/761{=}0.74$ at $k{=}4$, $561/1053{=}0.53$ at $k{=}8$, and $641/841{=}0.76$ at depth $2$.
ForkServe+ accuracy is $8/16$, $8/16$, $10/16$, and $1/16$ against APC $10/16$, $9/16$, $8/16$, and $1/16$.}
\end{table}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{fig/branch_peak.pdf}
\caption{Setting O peak KV.
ForkServe+ matches the ForkServe bar on every cell.
The spine stays at $550$, $569$, and $561$ from $k{=}2$ to $k{=}8$.}
\end{figure}

ForkServe+ at $k{=}8$ prunes $28$ branches on all three families and cuts fan-out from $307$ to $179$\,ms on Llama-3-8B, from $349$ to $191$\,ms on Mistral-7B, and from $363$ to $194$\,ms on DeepSeek-R1.
Disabling that prune (answer stop left on) returns fan-out to $247$\,ms on Llama-3-8B, $248$\,ms on Mistral-7B, and $271$\,ms on DeepSeek-R1, with the same peak and transfer tokens $376$, $364$, and $400$ instead of $92$ or $110$.
Disabling the last-line stop (prune left on) leaves fan-out at $176$\,ms, $174$\,ms, and $191$\,ms.
Decode tokens stay near $2500$--$3800$ rather than APC's $8192$, because only the winner is decoded and it already emits an EOS well inside $D{=}512$.
...
\toprule
 & & \multicolumn{2}{c}{Llama-3-8B} & \multicolumn{2}{c}{Mistral-7B} & \multicolumn{2}{c}{DeepSeek-R1} \\
\cmidrule(lr){3-4}\cmidrule(lr){5-6}\cmidrule(lr){7-8}
 & & APC & FS+ & APC & FS+ & APC & FS+ \\
\midrule
$1{\times}16$ & peak & $226$ & $176$ & $237$ & $187$ & $246$ & $196$ \\
 & e2e (s) & $19.8$ & $21.9$ & $28.2$ & $27.8$ & $52.9$ & $52.4$ \\
 & accuracy & $10/16$ & $9/16$ & $4/16$ & $5/16$ & $8/16$ & $7/16$ \\
$16$ in one step & peak & $2871$ & $2071$ & $2935$ & $2135$ & $2893$ & $2093$ \\
 & e2e (s) & $2.4$ & $4.4$ & $4.4$ & $3.6$ & $4.7$ & $4.7$ \\
 & accuracy & $12/16$ & $10/16$ & $4/16$ & $6/16$ & $10/16$ & $7/16$ \\
\bottomrule
\end{tabular}
\caption{Setting O batch width, GSM8K $n{=}16$, $k{=}4$.
Peak ratio is $0.78$--$0.80$ at one item, and $0.72$--$0.73$ when all $16$ share a step.
The wide step is the first GPU measurement of the concurrency term in \eqref{eq:conc}; it is not a closed-loop QPS sweep.}
\end{table}

On the $k{=}4$ main slice, Game24 peaks are $468/760{=}0.62$ (Llama), $472/816{=}0.58$ (Mistral), and $396/656{=}0.60$ (DeepSeek-R1).
HumanEval ($k{=}2$) is $747/751$, $845/837$, and $657/669$: the suffix dominates, so the spine sits on the APC peak.
Pass@1 is $3/16$ vs.\ $2/16$ on Llama, $6/16$ on every Mistral system, and $0/16$ on DeepSeek-R1.
...
\begin{tabular}{@{}llrrrrrr@{}}
\toprule
 & & \multicolumn{3}{c}{MATH-500 ($n{=}200$)} & \multicolumn{3}{c}{AIME ($n{=}73$)} \\
\cmidrule(lr){3-5}\cmidrule(lr){6-8}
 & & APC & FS & FS+ & APC & FS & FS+ \\
\midrule
DeepSeek-R1 & peak & $1863$ & $1391$ & $1391$ & $2118$ & $1646$ & $1646$ \\
 & accuracy & $111/200$ & $101/200$ & $101/200$ & $5/73$ & $7/73$ & $4/73$ \\
 & decode tokens & $409600$ & $227470$ & $228991$ & $149504$ & $146008$ & $145879$ \\
 & e2e (s) & $432.7$ & $431.2$ & $433.2$ & $178.3$ & $178.3$ & $199.9$ \\
 & fan-out (ms) & $1604$ & $2375$ & $1553$ & $613$ & $988$ & $670$ \\
Qwen3-4B & peak & $1937$ & $1521$ & $1521$ & $2150$ & $1734$ & $1734$ \\
 & accuracy & $127/200$ & $123/200$ & $127/200$ & $1/73$ & $5/73$ & $4/73$ \\
 & decode tokens & $409600$ & $286935$ & $265299$ & $149504$ & $147851$ & $148682$ \\
 & e2e (s) & $328.3$ & $326.3$ & $322.2$ & $135.4$ & $135.3$ & $138.0$ \\
 & fan-out (ms) & $1178$ & $1750$ & $1223$ & $462$ & $748$ & $501$ \\
\bottomrule
\end{tabular}%
}
\caption{Setting P, $D{=}2048$, $k{=}4$, $\mathrm{tp}{=}2$, batches of eight.
Peak ratios are $0.75$ and $0.78$ on DeepSeek-R1, $0.79$ and $0.81$ on Qwen3-4B.
ForkServe+ prunes $75$ MATH-500 branches and $30$ AIME branches on both models, which brings MATH-500 fan-out to $1553$\,ms (APC $1604$) and $1223$\,ms (APC $1178$).
Qwen3-4B ForkServe+ matches the APC MATH-500 score ($127/200$).
End-to-end stays with APC except DeepSeek-R1 AIME ForkServe+ ($199.9$ vs.\ $178.3$\,s).}
\end{table}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{fig/longcot_peak.pdf}
\caption{Setting P peak KV and fan-out.
ForkServe+ keeps the spine peak and closes the fan-out gap that ForkServe leaves against APC.}
\end{figure}
...
Setting N repeats the forest on six models ($n{=}40$): GSM8K peak $0.72$--$0.75\times$ APC and Game24 $0.57$--$0.62\times$ on every family; ForkServe accuracy tracks APC.
The last-line rerun ($n{=}32$) keeps GSM8K peak at $0.73$--$0.74\times$ APC.
ForkServe+ scores $18/32$ on DeepSeek-R1 (APC $16/32$) and $22/32$ on Llama-3-8B (APC $23/32$); Mistral-7B falls to $6/32$ from $11/32$.
HumanEval pass@1 on Mistral-7B is $0.350$ for every system, with peak $0.89\times$ APC.
Setting O shows the $k$ term directly: the spine stays at $550$ (Llama), $569$ (Mistral), and $561$ (DeepSeek-R1) from $k{=}2$ to $k{=}8$, and the ratio falls from $0.89$--$0.90$ to $0.53$--$0.55$.
A batch of $16$ keeps that ratio ($0.72$--$0.73$) on all three models and is the first measured wide step, not a closed-loop QPS sweep.
Setting P keeps the ratio at $0.75$--$0.81$ when $D{=}2048$; ForkServe+ returns MATH-500 fan-out to APC while end-to-end stays with APC because the contest trace spends the budget.
...
Setting N extends that storage claim to six families at $n{=}40$: GSM8K peak $0.72$--$0.75\times$ APC, Game24 $0.57$--$0.62\times$, ForkServe accuracy with APC.
The last-line rerun at $n{=}32$ scores $18/32$ on DeepSeek-R1 (APC $16/32$), $22/32$ on Llama-3-8B (APC $23/32$), and $6/32$ on Mistral-7B (APC $11/32$), with GSM8K peak $0.73$--$0.74\times$ APC.
Mistral-7B HumanEval pass@1 is $0.350$ ($14/40$) on recompute, APC, and ForkServe.
Setting O repeats the storage claim under a change of $k$: spine peak is flat and the ratio is $0.53$--$0.55$ at $k{=}8$ on Llama-3-8B, Mistral-7B, and DeepSeek-R1.
Draft prune is what cuts that fan-out ($179$ vs.\ $307$\,ms on Llama-3-8B, $194$ vs.\ $363$\,ms on DeepSeek-R1); the last-line stop is not, because the winner already ends inside $D$.
Setting P is the same claim at $D{=}2048$: MATH-500 peak $0.75\times$ (DeepSeek-R1) and $0.79\times$ (Qwen3-4B).
ForkServe+ prunes $75$ MATH-500 residuals on both models and returns fan-out to $1553$\,ms and $1223$\,ms, against APC at $1604$\,ms and $1178$\,ms, with generate time matched to APC.
