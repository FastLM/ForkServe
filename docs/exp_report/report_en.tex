...
A $k$ sweep on the same three models ($n{=}16$) leaves the spine flat while APC grows: the ratio moves from $0.89$--$0.90$ at $k{=}2$ to $0.55$ at $k{=}8$.
On MATH-500 ($n{=}200$, $D{=}2048$) DeepSeek-R1 peak is $0.75\times$ APC and Qwen3-4B peak is $0.79\times$, with end-to-end within $1\%$ of APC.
\end{abstract}
...
Qwen3-4B ForkServe+ on setting P is still running and is omitted.
...
DeepSeek-R1 at the same $n$ is $561/629{=}0.89$ at $k{=}2$ ($8/16$ ForkServe+ vs.\ $10/16$ APC) and $561/761{=}0.74$ at $k{=}4$ ($8/16$ vs.\ $9/16$).
Its $k{=}8$ and depth-$2$ runs are not finished.}
\end{table}

ForkServe+ at $k{=}8$ prunes $28$ branches on both families and brings fan-out below the $k{=}4$ ForkServe number.
Disabling that prune (answer stop left on) returns fan-out to $247$\,ms on Llama-3-8B and $248$\,ms on Mistral-7B, with the same peak ($550$, $569$) and transfer tokens $376$ and $364$ instead of $92$.
Disabling the last-line stop (prune left on) leaves fan-out at $176$\,ms and $174$\,ms.
...
\cmidrule(lr){3-4}\cmidrule(lr){5-6}
 & & APC & FS+ & APC & FS+ \\
\midrule
$1{\times}16$ & peak & $226$ & $176$ & $237$ & $187$ \\
 & e2e (s) & $19.8$ & $21.9$ & $28.2$ & $27.8$ \\
 & accuracy & $10/16$ & $9/16$ & $4/16$ & $5/16$ \\
$16$ in one step & peak & $2871$ & $2071$ & $2935$ & $2135$ \\
 & e2e (s) & $2.4$ & $4.4$ & $4.4$ & $3.6$ \\
 & accuracy & $12/16$ & $10/16$ & $4/16$ & $6/16$ \\
\bottomrule
\end{tabular}
\caption{Setting O batch width, GSM8K $n{=}16$, $k{=}4$.
Peak ratio is $0.78$ and $0.79$ at one item, and $0.72$ and $0.73$ when all $16$ share a step.
...
Qwen3-4B & peak & $1937$ & $1521$ & --- & $2150$ & $1734$ & --- \\
 & accuracy & $127/200$ & $123/200$ & --- & $1/73$ & $5/73$ & --- \\
 & decode tokens & $409600$ & $286935$ & --- & $149504$ & $147851$ & --- \\
 & e2e (s) & $328.3$ & $326.3$ & --- & $135.4$ & $135.3$ & --- \\
 & fan-out (ms) & $1178$ & $1750$ & --- & $462$ & $748$ & --- \\
\bottomrule
\end{tabular}%
}
...
ForkServe+ prunes $75$ MATH-500 branches and $30$ AIME branches on DeepSeek-R1, which is why its fan-out is below ForkServe.
The long trace still spends most of $D$, so end-to-end stays with APC except AIME ForkServe+ ($199.9$ vs.\ $178.3$\,s).}
\end{table}
...
Setting O shows the $k$ term directly: the spine stays at $550$ (Llama) and $569$ (Mistral) from $k{=}2$ to $k{=}8$, and the ratio falls from $0.90$ to $0.55$.
A batch of $16$ keeps that ratio ($0.72$--$0.73$) and is the first measured wide step, not a closed-loop QPS sweep.
Setting P keeps the ratio at $0.75$--$0.81$ when $D{=}2048$; end-to-end stays with APC because the contest trace spends the budget.
...
Setting O repeats the storage claim under a change of $k$: spine peak is flat and the ratio is $0.55$ at $k{=}8$.
Draft prune is what cuts that fan-out ($179$ vs.\ $307$\,ms on Llama-3-8B); the last-line stop is not, because the winner already ends inside $D$.
Setting P is the same claim at $D{=}2048$: MATH-500 peak $0.75\times$ (DeepSeek-R1) and $0.79\times$ (Qwen3-4B), with generate time matched to APC.
