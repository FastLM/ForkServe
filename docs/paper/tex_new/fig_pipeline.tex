...
\node[lab, anchor=west] at (0.10,0.08)
  {Takeaway: APC and stock P/D pay the clone on the first expand; CoW removes the clone; \app{} additionally drops $\Work$ and $\Xfer$ of losers before a kernel or \texttt{insert}.};
\end{tikzpicture}
