...
\multirow{-3}{*}{R1 MATH}
 & FS+ & $1599$ & $0.86$ & $0.545$ & $247$ \\
\midrule
 & APC & $2118$ & --- & $0.055$ & $178$ \\
\rowcolor{tblalt}
 & FS & \win{$1646$} & \win{$0.78$} & $0.123$ & $178$ \\
\multirow{-3}{*}{R1 AIME}
 & FS+ & $1662$ & $0.78$ & $0.096$ & $165$ \\
\midrule
 & APC & $1937$ & --- & $0.595$ & $329$ \\
\rowcolor{tblalt}
 & FS & \win{$1770$} & \win{$0.91$} & $0.610$ & $246$ \\
\multirow{-3}{*}{4B MATH}
 & FS+ & \win{$1770$} & \win{$0.91$} & $0.630$ & $230$ \\
\midrule
 & APC & $2150$ & --- & $0.027$ & $136$ \\
\rowcolor{tblalt}
 & FS & \win{$1794$} & \win{$0.83$} & $0.041$ & $135$ \\
\multirow{-3}{*}{4B AIME}
 & FS+ & \win{$1794$} & \win{$0.83$} & $0.055$ & $133$ \\
\bottomrule
\end{tabular}
\end{table}
...
ForkServe+ cuts DeepSeek-R1 from $429$\,s to $247$\,s and Qwen3-4B from $329$\,s to $230$\,s; the Qwen3-4B $n{=}32$ slice is $38$\,s versus $53$\,s.
ForkServe+ cuts MATH-500 fan-out from $2406$ to $1284$\,ms on DeepSeek-R1 and from $2747$ to $1140$\,ms on Qwen3-4B, against APC at $1593$ and $1188$\,ms.
Qwen3-4B ForkServe+ scores $126/200$ on MATH-500 (APC $119/200$).
