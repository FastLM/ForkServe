...
Spokes are normalized so the outer ring is the best value on that axis: quality, KV efficiency (inverse peak), and end-to-end speed.
(a)~GSM8K. (b)~Game24.
On the KV spoke, recompute lies inside the other three systems.}
...
\Cref{fig:eval-radar} repeats the comparison at $n{=}80$ with recompute and ForkServe+ included.
...
\rowcolor{tblhead}
\toprule
Model & Method & $k{=}2$ & $k{=}4$ & $k{=}8$ & depth $2$ \\
\midrule
 & APC & $610$ & $750$ & $998$ & $814$ \\
\rowcolor{tblalt}
...
\rowcolor{tblhead}
\toprule
Model & Method & peak & / APC & acc. & fan-out \\
\midrule
 & APC & $1863$ & --- & $0.555$ & $1604$ \\
\rowcolor{tblalt}
